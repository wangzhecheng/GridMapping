...
"""
This script is for running the line detetor on street view images.
...
save_dir = join('data/CAM_images', region)
old_ckpt_path = 'checkpoint/deepGrid_seg_pretrained.tar'
CAM_save_path = join('results', region, 'CAM_info_line.pickle')
