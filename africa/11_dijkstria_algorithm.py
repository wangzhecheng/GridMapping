...
# the point to start
start_lat_lon_dict = {
    'Nairobi_Highridge': (-1.2665153, 36.8163951),
    'Kampala_Ntinda': (0.3573126, 32.6118937),
    'Nairobi_Ngara': (-1.27873313, 36.8304583),
    'Lagos_Ikeja2': (6.58057096, 3.34231068),
    'Kampala_Kololo': (0.33553014, 32.57806758)
}
